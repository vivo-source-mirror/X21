...
#define SEC_SERIAL_NUM_ADDR         0x00784138
#define SEC_ENABLE_REG_ADDR         0x00780350 
#define SEC_KEY_VER_ADDR            (0x00780194) //key version bit 31:16
...
#define SEC_RPMB_KEY_PROVISION_ADDR 0x00784178 
