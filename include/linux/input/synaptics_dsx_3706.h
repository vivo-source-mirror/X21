...
#ifndef _SYNAPTICS_DSX_INCELL_H_
#define _SYNAPTICS_DSX_INCELL_H_

#include <linux/vivo_ts_function.h>

#define PLATFORM_DRIVER_NAME "synaptics_3706"
#define STYLUS_DRIVER_NAME "synaptics_dsx_stylus"
#define ACTIVE_PEN_DRIVER_NAME "synaptics_dsx_active_pen"
#define PROXIMITY_DRIVER_NAME "synaptics_dsx_proximity_3706"
#define GESTURE_DRIVER_NAME "synaptics_dsx_gesture_3706"
...
struct synaptics_dsx_board_data {
	...
	int rx_num;
	int tx_num;
	int suspend_event_blank;
	int resume_event_blank;
	bool swap_axes;
	int irq_gpio;
	int irq_on_state;
	int power_gpio;
	...
	unsigned int pm_cycle_supported;
