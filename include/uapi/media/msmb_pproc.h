...
enum msm_cpp_stream_t {
	MSM_CPP_STREAM_NO_OP = 0x1,
	MSM_CPP_STREAM_OFFLINE_PROC,
	MSM_CPP_STREAM_REGULAR_PROC,
	MSM_CPP_STREAM_DONOT_CARE,
};

enum msm_cpp_iommu_state_t {
	MSM_CPP_IOMMU_STATE_DETACHED,
	MSM_CPP_IOMMU_STATE_ATTACHED,
};
...
struct msm_cpp_stream_buff_info_t {
	...
	/* Jeff added for VIVO - begin */
	enum msm_cpp_stream_t stream_type;
	/* Jeff added for VIVO - end */
};
...
#define VIDIOC_MSM_CPP_GET_IMMU_STATE \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 21, struct msm_camera_v4l2_ioctl_t)
