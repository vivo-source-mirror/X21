...
struct mdss_dsi_ctrl_pdata {
	...
	int tp_rst_gpio;
	/*int oled_3v3_en_gpio; *//* oled 3.3v enable gpio */
	int disp_enp_gpio;
	int disp_enn_gpio;
	int disp_vddio_en;
	...
	struct dsi_panel_cmds hbm_level1_cmds;
	struct dsi_panel_cmds hbm_level2_cmds;
	struct dsi_panel_cmds hbm_ud_fingerprint_cmds;
	struct dsi_panel_cmds hbm_ud_fingerprint_off_cmds;
	struct dsi_panel_cmds hbm_off_cmds;
	struct dsi_panel_cmds partial_on_cmds;
	struct dsi_panel_cmds acl_on_cmds_level1;
	struct dsi_panel_cmds acl_on_cmds_level2;
	struct dsi_panel_cmds acl_on_cmds_level3;
	struct dsi_panel_cmds acl_off_cmds;
	struct dsi_panel_cmds seed_on_d65_cmds;
	struct dsi_panel_cmds seed_on_d78_cmds;
	struct dsi_panel_cmds dimming_speed_cmds;
	struct dsi_panel_cmds dimming_speed_fingerprint_cmds;
	struct dsi_panel_cmds dimming_speed_cmds_off;
	struct dsi_panel_cmds brightness_compensate_level1_cmds;
	struct dsi_panel_cmds brightness_compensate_level2_cmds;
	struct dsi_panel_cmds brightness_compensate_level3_cmds;
	struct dsi_panel_cmds brightness_compensate_level4_cmds;
	struct dsi_panel_cmds brightness_compensate_level5_cmds;
	struct dsi_panel_cmds brightness_compensate_off_cmds;
	struct dsi_panel_cmds aor_test_on_cmds;
	struct dsi_panel_cmds aor_test_off_cmds;
	struct dsi_panel_cmds dsi_ps_off_cmds;
	struct dsi_panel_cmds dsi_ps_on_cmds;
	struct dsi_panel_cmds dsi_hbm_gamma_cmds;
	struct dsi_panel_cmds dsi_delay_on_cmds;
	struct dsi_panel_cmds dsi_delay_off_cmds;
	...
	struct mutex panel_patial_lock;
	struct mutex hbm_state_lock;
	bool phy_power_off;
	struct mutex dynamic_clk_change_lock;
