...
#define MSM_CPP_CHECK_PRIORITY_TIMEOUT 13000
...
struct cpp_device {
	...
	int num_reg;
	struct mutex mutex;
	/* FIXME: add lock for before 2 states */
	...
	/* Jeff for VIVO - begin */
	atomic_t stream_cnt;
	atomic_t offline_pproc_cnt; /* higher priority */
	atomic_t regular_pproc_cnt; /* lower priority than offline */
	atomic_t cpp_open_cnt;
