...
int gf9118_stringlength(char *s);
void gf9118_sendnlmsg(char *message);
static int pid = -1;
...
void gf9118_nl_data_ready(struct sk_buff *__skb)
{
	struct sk_buff *skb;
	struct nlmsghdr *nlh;
	char str[100];
...
int gf9118_netlink_init(void)
{
	...
	netlink_cfg.flags = 0;
	netlink_cfg.input = gf9118_nl_data_ready;
